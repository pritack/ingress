...
function wrapper(plugin_info) {
    ...
    window.plugin.playerTracker.setup = function() {
        ...
        if (PLAYER.team == 'RESISTANCE') {
            window.addLayerGroup('Player Tracker Resistance 6hour', plugin.playerTracker.drawnTracesRes, true);
            window.addLayerGroup('Player Tracker Enlightened 6hour', plugin.playerTracker.drawnTracesEnl, true);
        } else {
            window.addLayerGroup('Player Tracker Enlightened 6hour', plugin.playerTracker.drawnTracesEnl, true);
            window.addLayerGroup('Player Tracker Resistance 6hour', plugin.playerTracker.drawnTracesRes, true);
        }
